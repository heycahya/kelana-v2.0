    ...
    <div class="max-w-[1400px] mx-auto px-6 py-5 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
            @if (Auth::guard('customer')->check())
                ...
                <!-- Chat/Support -->
                <a href="#" @click.prevent="isChatOpen = !isChatOpen; if(isChatOpen) { $nextTick(() => scrollChatToBottom()) }" class="text-graphite hover:text-[#1e5e3a] p-2 transition-colors relative" aria-label="Chat Support">
